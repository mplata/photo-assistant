...
const AlbumReview = ({ evaluation, onCloseDetail }: AlbumReviewProps) => {
  ...
  return (
    <div className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 px-8 py-4 bg-violet-300 border-4 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)] grid place-content-center">
      <div>
